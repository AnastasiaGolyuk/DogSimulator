...
class SubscriptionListArrayAdapter(private val context: Context?, private val list: List<SubscriptionListItem>) :
    ...
    override fun getItem(position: Int): SubscriptionListItem {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        view = LayoutInflater.from(context).inflate(R.layout.subscription_list_item, parent, false)
